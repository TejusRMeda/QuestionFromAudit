...
export default function ReviewPageClient({ linkId, initialData }: ReviewPageClientProps) {
  ...
  // Memoize validation to avoid recomputing on every render
  const validationErrors = useMemo(
    () => editPanelState.validate(),
    [editPanelState]
  );

    ...
    return (
      <div className="min-h-screen bg-base-200 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <Link href="/dashboard/trusts" className="btn btn-primary">
            Back to Dashboard
          </Link>
        </div>
      </div>
                ...
                <tbody>
                  {filteredTrusts.map((trust) => (
                    <tr key={trust.id} className="hover">
                      ...
                      <td>
                        {trust.suggestionCounts.total > 0 ? (
                          <a
                            href={`/api/instance/${trust.trustLinkId}/export/casod`}
                            className="btn btn-sm btn-outline btn-primary"
                            title="Export CASOD CSV"

 ...
 * Note: bmi-calculator and calculator DO use the Option column in CSV to define
 * their input/output fields (e.g. "height", "weight", "bmi"), but these are
 * field definitions, not user-selectable choices like radio/checkbox options.
 */

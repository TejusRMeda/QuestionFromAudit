...
export default function ResizableDivider({
  ...
  return (
    <div
      className="w-11 flex-shrink-0 cursor-col-resize relative group flex items-center justify-center"
    ...
    >
      {/* Visible divider line — thicker on hover */}
      <div className="w-px h-full bg-slate-200 group-hover:w-1 group-hover:bg-primary/50 transition-all duration-150" />
      {/* Hover highlight zone */}
      <div className="absolute inset-y-0 inset-x-0.5 group-hover:bg-primary/5 transition-colors rounded" />
      {/* Drag handle — visible grip indicator */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-1 opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity">

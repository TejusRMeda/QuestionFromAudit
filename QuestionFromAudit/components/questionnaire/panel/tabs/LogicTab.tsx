                ...
                {translatedEnableWhen.conditions.map((condition, idx) => (
                  <div key={idx} className="flex items-center gap-2 text-sm">
                    ...
                    <span
                      className={
                        condition.raw
                          ? "font-mono text-xs bg-slate-200 px-1 py-0.5 rounded"
                          : ""
                      }
                    >
                      {condition.readable}
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          {parentQuestions.length > 0 && (
            <>
              <div className="w-full space-y-2">
                <p className="text-xs text-slate-500 text-center">Depends on:</p>
          ...
          {childQuestions.length > 0 && (
            <>
              ...
              <div className="w-full space-y-2">
                <p className="text-xs text-slate-500 text-center">Controls display of:</p>
      ...
      <div>
        ...
        <div
          className={`rounded-lg border transition-colors ${
            hasChanges ? "border-[#4A90A4] bg-[#4A90A4]/5" : "border-slate-200 bg-white"
          }`}
        >
          <div className="p-4">
            ...
            <Textarea
              ...
              className={hasChanges ? "border-[#4A90A4] ring-1 ring-[#4A90A4]/20" : ""}
              rows={4}
            />

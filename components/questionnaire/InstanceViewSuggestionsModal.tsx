...
interface InstanceViewSuggestionsModalProps {
  isOpen: boolean;
  onClose: () => void;
  question: Question | null;
  trustLinkId: string;
...
export default function InstanceViewSuggestionsModal({
  isOpen,
  onClose,
  question,
  trustLinkId,
  onSuggestChange,
}: InstanceViewSuggestionsModalProps) {
  ...
  const openThreadModal = (suggestion: Suggestion) => {
    // Add question info to suggestion for the thread modal
                      ...
                      suggestions.map((suggestion) => (
                        ...
                        >
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <div className="flex items-center gap-2">
                              {suggestion.commentCount !== undefined && suggestion.commentCount > 0 && (
                          ...
                          <div className="mt-3 pt-3 border-t border-base-300">
                            ...
                            >
                              ...
                              View Thread
                              {suggestion.commentCount !== undefined && suggestion.commentCount > 0 && ` (${suggestion.commentCount})`}
                            </button>
                          </div>
                        </div>
                      ))
